...
const iconPaths: Record<string, string> = {
  ...
  "chat-alt": "M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z",
...
const FALLBACK_PATH = "M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zM21 5a2 2 0 00-2-2h-4a2 2 0 00-2 2v12a4 4 0 004 4 4 4 0 004-4V5z";
                ...
                >
                  ...
                  <div className="flex items-center gap-1.5">
                    {(categoryDevCounts?.[category] ?? 0) > 0 && (
                      <span className="flex h-5 min-w-5 items-center justify-center rounded-full bg-violet-500/10 px-1.5 text-[10px] font-semibold leading-none text-violet-600 dark:text-violet-400">
